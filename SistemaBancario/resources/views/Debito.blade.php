...
<div class="bg-faded p-4 my-4">
    <div class="bg-faded p-4 my-4">
        ...
        <h2 class="text-center text-lg text-uppercase my-0">
            <strong>Debitar</strong>
        </h2>
        <hr class="divider">
        <form method="POST" action="{{ route('debitar') }}">
            <div class="row">
            ...
            <div class="form-group col-lg-6">
                <label class="text-heading">Monto a debitar</label>
                <input name="monto" class="form-control">
            </div>
            <div class="form-group col-lg-12">
                <label class="text-heading">Descripcion del debito</label>
